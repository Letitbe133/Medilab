  ...
  <body>
    ...
    <main>
      ...
      <section class="row grey lighten-4">
        <div class="col s12">
          <h2 class="green-text">Activities</h2>
        </div>
        <div class="col s12 l4">
      ...
      <section class="row grey lighten-4">
        <div class="col s12 l6">
          <h2 class="green-text">Products</h2>
        </div>
        <form class="col s10 offset-s1 l6">
      ...
      <section class="row">
        <div class="col s12">
          <h2 class="green-text">Partners</h2>
        </div>
      ...
      <section class="row grey lighten-4">
        <div class="col s12">
          <h2 class="green-text">Contact</h2>
        </div>
        <form class="col s10 offset-s1 l8">
          ...
          <div class="row">
            <div class="col s12 l3 offset-l9 center-align">
              <button class="btn waves-effect waves-light" type="submit" name="submit">Send message
